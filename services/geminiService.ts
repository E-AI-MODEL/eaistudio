...
const responseSchema: Schema = {
  ...
  properties: {
    ...
    analysis: {
      ...
      required: ["process_phases", "coregulation_bands", "task_densities", "reasoning", "current_profile", "task_density_balance", "epistemic_status", "cognitive_mode"],
    },
  },
...
export const sendMessageToGemini = async (message: string): Promise<{ text: string; analysis: EAIAnalysis; mechanical: MechanicalState }> => {
  try {
    ...
    try {
      ...
      const analysisData: EAIAnalysis = {
        ...
        // Set default to 70 instead of 50 to favor learner agency if undefined
        task_density_balance: parsed.analysis.task_density_balance ?? 70,
      ...
      return {
        ...
        analysis: {
            ...
            task_density_balance: 70, // Default to 70 on error
